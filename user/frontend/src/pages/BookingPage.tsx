...
const BookingPage = ({ onBack }: BookingPageProps) => {
  ...
  const checkboxOptions = {
    ...
    preferredCocktails: [
      "Classic (Old Fashioned, Manhattan, Martini)",
      "Tropical (Mojito, Piña Colada, Daiquiri)",
      "Contemporary (Cosmopolitan, Moscow Mule)",
      "Indian Fusion (Masala Margarita, Curry Leaf Cocktail)",
    ],
    preferredAttire: [
      "Formal (Black Suit/Tie)",
      "Semi-formal (Black Shirt/Trousers)",
      "Themed Attire",
      "Casual Professional",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Pass the full response data (which includes the new ID) to the next page
        navigate("/bartenders", { state: { bookingData: responseData } });
      } else {
  ...
  const isStep3Valid =
    ...
    formData.venueType;
  const isStep4Valid =
    formData.preferredBarLocation.length > 0 &&
    (formData.barTableAvailable || formData.arrangeTemporarySetup) &&
    formData.powerOutletAvailable &&
    formData.waterSourceAvailable;
  const isStep5Valid =
    (formData.wineGlassesAvailable ||
      formData.beerMugsAvailable ||
      formData.whiskeyGlassesAvailable ||
      formData.shotGlassesAvailable ||
      ...
      formData.disposableOptionsAvailable) &&
    (formData.cocktailShakerAvailable ||
      formData.barSpoonsAvailable ||
      formData.muddlerAvailable ||
      formData.jiggerAvailable ||
      formData.strainerAvailable ||
      formData.bottleOpenerAvailable ||
      formData.corkscrewAvailable ||
      formData.cuttingBoardAvailable ||
      formData.sharpKnifeAvailable) &&
    (formData.refrigeratorAccess ||
      formData.freezerAccess ||
      formData.iceBucketsAvailable ||
      formData.coolersAvailable);
  const isStep6Valid =
    (formData.servingTraysAvailable ||
      formData.cocktailNapkinsAvailable ||
      formData.coastersAvailable ||
      formData.iceTongsAvailable ||
      formData.servingSpoonsAvailable) &&
            ...
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                <span>
                  ...
                  {currentStep === 7 && "Alcohol & Beverage Preferences"}
                  {currentStep === 8 &&
                    "Service Preferences & Special Requests"}
                </span>
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("onSiteContactPerson", e.target.value)
                      }
                    />
                    <Input
                    ...
                    />
                    <Input
                      placeholder="Relationship to Host"
                      value={formData.relationshipToHost}
                      onChange={(e) =>
                        handleInputChange("relationshipToHost", e.target.value)
                      }
                    />
                  </div>
                )}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleDropdownChange("eventType", value)
                          }
                        >
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="number"
                          placeholder="Expected Duration of Bar Service (hours)"
                          value={formData.barServiceDuration}
                          onChange={(e) =>
                            handleInputChange(
                              "barServiceDuration",
                              e.target.value
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("totalGuests", e.target.value)
                          }
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("adultGuests", e.target.value)
                          }
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          type="number"
                          placeholder="Number of Minors (if any)"
                          value={formData.minorGuests}
                          onChange={(e) =>
                            handleInputChange("minorGuests", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          type="time"
                          placeholder="Peak Bar Usage Start Time"
                          value={formData.peakBarUsageStartTime}
                          onChange={(e) =>
                            handleInputChange(
                              "peakBarUsageStartTime",
                              e.target.value
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="time"
                          placeholder="Peak Bar Usage End Time"
                          value={formData.peakBarUsageEndTime}
                          onChange={(e) =>
                            handleInputChange(
                              "peakBarUsageEndTime",
                              e.target.value
                    ...
                    <h3 className="text-lg font-medium">
                      Event Theme & Atmosphere
                    </h3>
                    <div className="space-y-2">
                      <Label>Event Theme (if any)</Label>
                      <Input
                        placeholder="e.g., Tropical, 80s, etc."
                        value={formData.eventTheme}
                        onChange={(e) =>
                          handleInputChange("eventTheme", e.target.value)
                        }
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {checkboxOptions.preferredAtmosphere.map((option) => (
                          ...
                          >
                            <Checkbox
                              checked={formData.preferredAtmosphere.includes(
                                option
                              )}
                ...
                {currentStep === 3 && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <Select
                        onValueChange={(value) =>
                          handleDropdownChange("venueType", value)
                        }
                      >
                        <SelectTrigger>
                      ...
                      {formData.venueType === "Other" && (
                        <Input
                          placeholder="Please specify"
                          onChange={(e) =>
                            handleInputChange("venueTypeOther", e.target.value)
                          }
                        />
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {formData.parkingAvailable && (
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) =>
                              handleInputChange("parkingType", value)
                            }
                          >
                            <SelectTrigger>
                      ...
                      <Input
                        type="number"
                        placeholder="Floor Number (if applicable)"
                    ...
                    <Input
                      ...
                      value={formData.specialEntryInstructions}
                      onChange={(e) =>
                        handleInputChange(
                          "specialEntryInstructions",
                          e.target.value
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {checkboxOptions.preferredBarLocation.map((option) => (
                          ...
                          >
                            <Checkbox
                              checked={formData.preferredBarLocation.includes(
                                option
                              )}
                              onCheckedChange={(checked) =>
                                handleCheckboxChange(
                      ...
                      {formData.preferredBarLocation.includes(
                        "Specific Location"
                      ) && (
                        <Input
                          placeholder="Please specify"
                      ...
                      <div className="flex items-center space-x-2 ml-6">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            setFormData((prev) => ({
                              ...prev,
                              arrangeTemporarySetup: checked as boolean,
                            }))
                          }
                        />
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
                              powerOutletAvailable: value === "yes",
                            }))
                          }
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
                              waterSourceAvailable: value === "yes",
                            }))
                          }
                      ...
                      {formData.waterSourceAvailable && (
                        <Input
                          type="number"
                          placeholder="Distance to Nearest Water Point (meters)"
                          value={formData.distanceToWaterPoint}
                          onChange={(e) =>
                            handleInputChange(
                              "distanceToWaterPoint",
                              e.target.value
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                wineGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                beerMugsAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                whiskeyGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                shotGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Shot Glasses —consult with bartender
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                champagneFlutesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cocktailGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                highballGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                margaritaGlassesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                disposableOptionsAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cocktailShakerAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                barSpoonsAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                muddlerAvailable: checked as boolean,
                              }))
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                jiggerAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Jigger/Measuring Tools —consult with bartender
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                strainerAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                bottleOpenerAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                corkscrewAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cuttingBoardAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                sharpKnifeAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                servingTraysAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                largeTraysAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                smallCocktailTraysAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Small Cocktail Trays
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                antiSlipTraysAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Anti-slip Trays —consult with bartender
                          </Label>
                        </div>
                        <div className="space-y-2">
                          ...
                          <RadioGroup
                            onValueChange={(value) =>
                              setFormData((prev) => ({
                                ...prev,
                                cocktailNapkinsAvailable: value === "yes",
                              }))
                            }
                            value={
                              formData.cocktailNapkinsAvailable ? "yes" : "no"
                            }
                            className="flex space-x-4"
                          >
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <RadioGroup
                            onValueChange={(value) =>
                              setFormData((prev) => ({
                                ...prev,
                                servingSpoonsAvailable: value === "yes",
                              }))
                            }
                            value={
                              formData.servingSpoonsAvailable ? "yes" : "no"
                            }
                            className="flex space-x-4"
                          >
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                freshFruitsAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                lemonsAvailable: checked as boolean,
                              }))
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                limesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Limes —consult with bartender
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                orangesAvailable: checked as boolean,
                              }))
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                otherFruitsAvailable: checked as boolean,
                              }))
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cherriesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                mintLeavesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cucumberAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                olivesAvailable: checked as boolean,
                              }))
                            }
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                softDrinksAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                cokePepsiAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                            Coke/Pepsi —consult with bartender
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                sprite7upAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                otherSodasAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                tonicWaterAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                sodaWaterAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                gingerAleAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                freshJuicesAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                regularWaterAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                        ...
                        <div className="flex items-center space-x-2 ml-6">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              setFormData((prev) => ({
                                ...prev,
                                sparklingWaterAvailable: checked as boolean,
                              }))
                            }
                          />
                          <Label className="text-sm font-normal">
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            setFormData((prev) => ({
                              ...prev,
                              specificRequirementsAvailable: checked as boolean,
                            }))
                          }
                        />
                        <Label className="text-sm font-normal">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                      ...
                      <p className="text-sm text-blue-800 mt-1 italic">
                        As per our service model, customers are responsible for
                        purchasing and providing all alcoholic beverages. Our
                        bartenders provide professional service only.
                      </p>
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
                              signatureCocktailDesired: value === "yes",
                            }))
                          }
                          value={
                            formData.signatureCocktailDesired ? "yes" : "no"
                          }
                          defaultValue="no"
                          className="flex space-x-4"
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {checkboxOptions.preferredCocktails.map((option) => (
                            ...
                            >
                              <Checkbox
                                checked={formData.preferredCocktails.includes(
                                  option
                                )}
                                onCheckedChange={(checked) =>
                                  handleCheckboxChange(
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
                              sugarFreeOptionsRequired: value === "yes",
                            }))
                          }
                          value={
                            formData.sugarFreeOptionsRequired ? "yes" : "no"
                          }
                          defaultValue="no"
                          className="flex space-x-4"
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          onValueChange={(value) =>
                            setFormData((prev) => ({
                              ...prev,
                              lowAlcoholMocktailOptions: value === "yes",
                            }))
                          }
                          value={
                            formData.lowAlcoholMocktailOptions ? "yes" : "no"
                          }
                          defaultValue="no"
                          className="flex space-x-4"
                        >
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {checkboxOptions.preferredAttire.map((option) => (
                            ...
                            >
                              <Checkbox
                                checked={formData.preferredAttire.includes(
                                  option
                                )}
                                onCheckedChange={(checked) =>
                                  handleCheckboxChange(
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          {checkboxOptions.languagePreferences.map((option) => (
                            ...
                            >
                              <Checkbox
                                checked={formData.languagePreferences.includes(
                                  option
                                )}
                                onCheckedChange={(checked) =>
                                  handleCheckboxChange(
        ...
        <DialogContent className="sm:max-w-md [&>button]:hidden">
          <DialogHeader>
            <DialogTitle className="text-destructive">
              Option Cannot Be Canceled
            </DialogTitle>
          </DialogHeader>
          <div className="py-4">
            <p className="text-sm text-muted-foreground mb-6">
              This option cannot be canceled once selected. You must go back to
